...
$pull = shell_exec("/usr/local/cpanel/bin/uapi VersionControl update repository_root='/home/YOUR_CPANEL_USERNAME/your_repo_folder' 2>&1");

// 2. "Deploy HEAD Commit" (Runs your .cpanel.yml instructions to copy files live)
$deploy = shell_exec("/usr/local/cpanel/bin/uapi VersionControlDeployment create repository_root='/home/YOUR_CPANEL_USERNAME/your_repo_folder' 2>&1");
